...
echo addNPCBox(19, $txt['safari_npc_title'], $txt['safari_event_npc_text']);
...
<div class="menuu" style="width: 87px;margin-top: auto;"><center>
			<a class="map1" title="<?php echo $txt['safari_map_grass']; ?>" href="./eventos&actual=safari&amp;map=1"><img src="public/images/animation.gif"></a>
			<a class="map2" title="<?php echo $txt['safari_map_water']; ?>" href="./eventos&actual=safari&amp;map=2"><img src="public/images/animation.gif"></a>
			<a class="map3" title="<?php echo $txt['safari_map_cave']; ?>" href="./eventos&actual=safari&amp;map=3"><img src="public/images/animation.gif"></a>
			<a class="map4" title="<?php echo $txt['safari_map_tower']; ?>" href="./eventos&actual=safari&amp;map=4"><img src="public/images/animation.gif"></a>
			<a class="map5" title="<?php echo $txt['safari_map_lava']; ?>" href="./eventos&actual=safari&amp;map=5"><img src="public/images/animation.gif"></a>
			<a class="map6" title="<?php echo $txt['safari_map_beach']; ?>" href="./eventos&actual=safari&amp;map=6"><img src="public/images/animation.gif"></a>
			<a class="map7" title="<?php echo $txt['safari_map_dojo']; ?>" href="./eventos&actual=safari&amp;map=7"><img src="public/images/animation.gif"></a>
