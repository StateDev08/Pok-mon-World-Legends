...
<div class="box-content" style="float: left; width: 100%; margin-top: 10px; margin-bottom: 10px">
	<table class="general" width="100%">
		<thead><tr>
			<th><?=$txt['online_users'].' ('.$total_online.')'?></th>
		</tr></thead>
		<tbody><tr><td><?php
		
		if ($total_online == 0) { 
			echo '<h3>'.$txt['nobody_online'].'</h3>';
		} else { 
			$i = 1;
			...
			$block_check = strpos(($gebruiker['blocklist'] ?? ''), $fixt);
				...
				if ($online['admin'] == 1)								$name = "<div class='admin_container'><span style='color: #A1FF77; text-shadow:#000 1px -1px 2px, #000 -1px 1px 2px, #000 1px 1px 2px, #000 -1px -1px 2px'><b>".$online['username']."</b></span> <img src=\"".$static_url."/images/icons/user.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"ico\" title=\"".$txt['online_moderator']."\" style=\"margin-bottom:-3px;\">";
				else if ($online['admin'] == 2)							$name = "<div class='admin_container'><span style='color: #FF3030; text-shadow:#000 1px -1px 2px, #000 -1px 1px 2px, #000 1px 1px 2px, #000 -1px -1px 2px'><b>".$online['username']."</b></span> <img src=\"".$static_url."/images/icons/user_suit.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"ico\" title=\"".$txt['online_supervisor']."\" style=\"margin-bottom:-3px;\">";
				...
				else if ($online['dv'] == 1)							$name = "<div class='name_container'><b><span style='color: orange; text-shadow:#000 1px -1px 2px, #000 -1px 1px 2px, #000 1px 1px 2px, #000 -1px -1px 2px'>[DV]".$online['username']."</span></b> <img src=\"".$static_url."/images/icons/dv.png\" width=\"16\" height=\"16\" border=\"0\" alt=\"ico\" title=\"".$txt['online_divulgador']."\" style=\"margin-bottom:-3px;\">";
				...
				if ($online['rang'] >= 1 && $online['rang'] <= 4 && $online['admin'] == 0) $name .= '<img src="'.$static_url.'/images/icons/elite.png" width="16" height="16" border="0" alt="'.$txt['online_elite_four'].'" title="'.$txt['online_elite_four'].'">';
					
				if (($online['premiumaccount'] > time()) && ($online['admin'] == 0)) $name .= '<img src="'.$static_url.'/images/icons/vip.gif" width="16" height="16" border="0" alt="'.$txt['online_premium'].'" title="'.$txt['online_premium'].'" style="margin-bottom:-3px;">';
